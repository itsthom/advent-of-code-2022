import { day5, readInput } from '../allTheModules.js'
...
describe('function: calculateSeatId', () => {
  test('using the test input', () => {
    testInput.forEach((x) => {
      expect(day5.mod.calculateSeatId(x.str)).toBe(x.id)
    })
  })
})
...
describe('function: findMissingSeatId', () => {
  test('return the first missing item in the sequence', () => {
    ...
    expect(day5.mod.findMissingSeatId(sequence)).toBe(4)
  })
  test('return the first missing item in the sequence', () => {
    const sequence = [1, 2, 4]
    expect(day5.mod.findMissingSeatId(sequence)).toBe(3)
  })
  test('return the first missing item in the sequence', () => {
    const sequence = [1, 3]
    expect(day5.mod.findMissingSeatId(sequence)).toBe(2)
  })
})

describe('function: solution', () => {
  test('with my test input', () => {
    const sol = day5.mod.solution(readInput(day5.input))
